class WorkExperiencesController < ApplicationController
  ...
  def show
    @work_experience = WorkExperience.find(params[:id]) # Fetch the work experience you want to display
  end
  private
  ...
  def work_experience_params
    params.require(:work_experience).permit(:start_date, :end_date, :job_title, :employment_type, :location,    :location_type, :current_working_here, :description, :company, :user_id)
  end
end